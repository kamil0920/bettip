            ...
            for model_type in _base_types:
                ...
                try:
                    if model_type.startswith("two_stage_"):
                        ...
                        sklearn_cal = "sigmoid" if cal_method in ("beta", "temperature") else cal_method
