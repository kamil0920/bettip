...
BET_TYPES = {
    "away_win": {
        ...
        "threshold_search": [0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
    ...
    "btts": {
        ...
        "approach": "classification",
        "default_threshold": 0.65,  # Lower threshold for BTTS (high base rate ~50%)
        # S30: lowered floor — pred_max=0.683 < old floor 0.72 → 0 holdout bets
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
    ...
    "under15": {
        ...
        "approach": "classification",
        "default_threshold": 0.65,  # Lower — ~21% base rate
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
    ...
    "corners": {
        ...
        "approach": "regression_line",
        "default_threshold": 0.65,  # Lower threshold for ~32% base rate at this line
        # S30: lowered floor — holdout pred_max < 0.72 → 0 bets
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
    ...
    "cards": {
        ...
        "approach": "regression_line",
        "default_threshold": 0.65,  # Lower threshold for ~37% base rate
        # S30: lowered floor — holdout pred_max < 0.72 → 0 bets
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
    ...
    # Shots variants (22.5-27.5, step 1.0)
    "shots_over_225": {
        "target": "total_shots",
        "target_line": 22.5,
    ...
    # --- Per-team niche markets (corners, shots, fouls, yellow cards) ---
    # Home corners (3.5-6.5)
    "home_corners_over_35": {
        "target": "home_corners",
        "target_line": 3.5,
        "odds_col": "home_corners_over_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "home_corners_over_45": {
        "target": "home_corners",
        "target_line": 4.5,
        "odds_col": "home_corners_over_avg_45",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_corners_over_55": {
        "target": "home_corners",
        "target_line": 5.5,
        "odds_col": "home_corners_over_avg_55",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_corners_over_65": {
        "target": "home_corners",
        "target_line": 6.5,
        "odds_col": "home_corners_over_avg_65",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
    ...
    "home_corners_under_35": {
        "target": "home_corners",
        "target_line": 3.5,
        "direction": "under",
        "odds_col": "home_corners_under_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "home_corners_under_45": {
        "target": "home_corners",
        "target_line": 4.5,
        "direction": "under",
        "odds_col": "home_corners_under_avg_45",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_corners_under_55": {
        "target": "home_corners",
        "target_line": 5.5,
        "direction": "under",
        "odds_col": "home_corners_under_avg_55",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_corners_under_65": {
        "target": "home_corners",
        "target_line": 6.5,
        "direction": "under",
        "odds_col": "home_corners_under_avg_65",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    # Away corners (2.5-5.5)
    "away_corners_over_25": {
        "target": "away_corners",
        "target_line": 2.5,
        "odds_col": "away_corners_over_avg_25",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "away_corners_over_35": {
        "target": "away_corners",
        "target_line": 3.5,
        "odds_col": "away_corners_over_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_corners_over_45": {
        "target": "away_corners",
        "target_line": 4.5,
        "odds_col": "away_corners_over_avg_45",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_corners_over_55": {
        "target": "away_corners",
        "target_line": 5.5,
        "odds_col": "away_corners_over_avg_55",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "away_corners_under_25": {
        "target": "away_corners",
        "target_line": 2.5,
        "direction": "under",
        "odds_col": "away_corners_under_avg_25",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "away_corners_under_35": {
        "target": "away_corners",
        "target_line": 3.5,
        "direction": "under",
        "odds_col": "away_corners_under_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_corners_under_45": {
        "target": "away_corners",
        "target_line": 4.5,
        "direction": "under",
        "odds_col": "away_corners_under_avg_45",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_corners_under_55": {
        "target": "away_corners",
        "target_line": 5.5,
        "direction": "under",
        "odds_col": "away_corners_under_avg_55",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    # Home shots (10.5-16.5)
    "home_shots_over_105": {
        "target": "home_shots",
        "target_line": 10.5,
        "odds_col": "home_shots_over_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "home_shots_over_125": {
        "target": "home_shots",
        "target_line": 12.5,
        "odds_col": "home_shots_over_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_shots_over_145": {
        "target": "home_shots",
        "target_line": 14.5,
        "odds_col": "home_shots_over_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_shots_over_165": {
        "target": "home_shots",
        "target_line": 16.5,
        "odds_col": "home_shots_over_avg_165",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "home_shots_under_105": {
        "target": "home_shots",
        "target_line": 10.5,
        "direction": "under",
        "odds_col": "home_shots_under_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "home_shots_under_125": {
        "target": "home_shots",
        "target_line": 12.5,
        "direction": "under",
        "odds_col": "home_shots_under_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_shots_under_145": {
        "target": "home_shots",
        "target_line": 14.5,
        "direction": "under",
        "odds_col": "home_shots_under_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_shots_under_165": {
        "target": "home_shots",
        "target_line": 16.5,
        "direction": "under",
        "odds_col": "home_shots_under_avg_165",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "away_shots_over_85": {
        "target": "away_shots",
        "target_line": 8.5,
        "odds_col": "away_shots_over_avg_85",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "away_shots_over_105": {
        "target": "away_shots",
        "target_line": 10.5,
        "odds_col": "away_shots_over_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_shots_over_125": {
        "target": "away_shots",
        "target_line": 12.5,
        "odds_col": "away_shots_over_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_shots_over_145": {
        "target": "away_shots",
        "target_line": 14.5,
        "odds_col": "away_shots_over_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "away_shots_under_85": {
        ...
        "target_line": 8.5,
        "direction": "under",
        "odds_col": "away_shots_under_avg_85",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "away_shots_under_105": {
        "target": "away_shots",
        "target_line": 10.5,
        "direction": "under",
        "odds_col": "away_shots_under_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_shots_under_125": {
        "target": "away_shots",
        "target_line": 12.5,
        "direction": "under",
        "odds_col": "away_shots_under_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_shots_under_145": {
        "target": "away_shots",
        "target_line": 14.5,
        "direction": "under",
        "odds_col": "away_shots_under_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    # Home fouls (10.5-14.5)
    "home_fouls_over_105": {
        "target": "home_fouls",
        "target_line": 10.5,
        "odds_col": "home_fouls_over_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_fouls_over_125": {
        "target": "home_fouls",
        "target_line": 12.5,
        "odds_col": "home_fouls_over_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_fouls_over_145": {
        "target": "home_fouls",
        "target_line": 14.5,
        "odds_col": "home_fouls_over_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "home_fouls_under_105": {
        "target": "home_fouls",
        "target_line": 10.5,
        "direction": "under",
        "odds_col": "home_fouls_under_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_fouls_under_125": {
        "target": "home_fouls",
        "target_line": 12.5,
        "direction": "under",
        "odds_col": "home_fouls_under_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_fouls_under_145": {
        "target": "home_fouls",
        "target_line": 14.5,
        "direction": "under",
        "odds_col": "home_fouls_under_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    # Away fouls (10.5-14.5)
    "away_fouls_over_105": {
        "target": "away_fouls",
        "target_line": 10.5,
        "odds_col": "away_fouls_over_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_fouls_over_125": {
        "target": "away_fouls",
        "target_line": 12.5,
        "odds_col": "away_fouls_over_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_fouls_over_145": {
        "target": "away_fouls",
        "target_line": 14.5,
        "odds_col": "away_fouls_over_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "away_fouls_under_105": {
        "target": "away_fouls",
        "target_line": 10.5,
        "direction": "under",
        "odds_col": "away_fouls_under_avg_105",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_fouls_under_125": {
        "target": "away_fouls",
        "target_line": 12.5,
        "direction": "under",
        "odds_col": "away_fouls_under_avg_125",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_fouls_under_145": {
        "target": "away_fouls",
        "target_line": 14.5,
        "direction": "under",
        "odds_col": "away_fouls_under_avg_145",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    # Home yellows (1.5-3.5)
    "home_yellows_over_15": {
        "target": "home_yellow_cards",
        "target_line": 1.5,
        "odds_col": "home_yellow_cards_over_avg_15",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "home_yellows_over_25": {
        "target": "home_yellow_cards",
        "target_line": 2.5,
        "odds_col": "home_yellow_cards_over_avg_25",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_yellows_over_35": {
        "target": "home_yellow_cards",
        "target_line": 3.5,
        "odds_col": "home_yellow_cards_over_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "home_yellows_under_15": {
        "target": "home_yellow_cards",
        "target_line": 1.5,
        "direction": "under",
        "odds_col": "home_yellow_cards_under_avg_15",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "home_yellows_under_25": {
        "target": "home_yellow_cards",
        "target_line": 2.5,
        "direction": "under",
        "odds_col": "home_yellow_cards_under_avg_25",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "home_yellows_under_35": {
        "target": "home_yellow_cards",
        "target_line": 3.5,
        "direction": "under",
        "odds_col": "home_yellow_cards_under_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    # Away yellows (1.5-3.5)
    "away_yellows_over_15": {
        "target": "away_yellow_cards",
        "target_line": 1.5,
        "odds_col": "away_yellow_cards_over_avg_15",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_yellows_over_25": {
        "target": "away_yellow_cards",
        "target_line": 2.5,
        "odds_col": "away_yellow_cards_over_avg_25",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_yellows_over_35": {
        "target": "away_yellow_cards",
        "target_line": 3.5,
        "odds_col": "away_yellow_cards_over_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.6, 1.8, 2.0, 2.5, 3.0],
    ...
    "away_yellows_under_15": {
        "target": "away_yellow_cards",
        "target_line": 1.5,
        "direction": "under",
        "odds_col": "away_yellow_cards_under_avg_15",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_yellows_under_25": {
        "target": "away_yellow_cards",
        "target_line": 2.5,
        "direction": "under",
        "odds_col": "away_yellow_cards_under_avg_25",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.2, 1.4, 1.6, 1.8],
    ...
    "away_yellows_under_35": {
        "target": "away_yellow_cards",
        "target_line": 3.5,
        "direction": "under",
        "odds_col": "away_yellow_cards_under_avg_35",
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.75, 0.78, 0.80, 0.83],
        "min_odds_search": [1.05, 1.10, 1.15, 1.20],
    ...
    "sot_over_85": {
        ...
        "approach": "regression_line",
        "default_threshold": 0.65,
        "threshold_search": [0.65, 0.70, 0.72, 0.74, 0.75, 0.76, 0.78, 0.80, 0.83],
...
BASE_MARKET_MAP = {
    ...
    # Per-team corners (3.5-6.5)
    "home_corners_over_35": "home_corners", "home_corners_over_45": "home_corners",
    "home_corners_over_55": "home_corners", "home_corners_over_65": "home_corners",
    "home_corners_under_35": "home_corners", "home_corners_under_45": "home_corners",
    "home_corners_under_55": "home_corners", "home_corners_under_65": "home_corners",
    # Per-team corners away (2.5-5.5)
    "away_corners_over_25": "away_corners", "away_corners_over_35": "away_corners",
    "away_corners_over_45": "away_corners", "away_corners_over_55": "away_corners",
    "away_corners_under_25": "away_corners", "away_corners_under_35": "away_corners",
    "away_corners_under_45": "away_corners", "away_corners_under_55": "away_corners",
    # Per-team shots home (10.5-16.5)
    "home_shots_over_105": "home_shots", "home_shots_over_125": "home_shots",
    "home_shots_over_145": "home_shots", "home_shots_over_165": "home_shots",
    "home_shots_under_105": "home_shots", "home_shots_under_125": "home_shots",
    "home_shots_under_145": "home_shots", "home_shots_under_165": "home_shots",
    # Per-team shots away (8.5-14.5)
    "away_shots_over_85": "away_shots", "away_shots_over_105": "away_shots",
    "away_shots_over_125": "away_shots", "away_shots_over_145": "away_shots",
    "away_shots_under_85": "away_shots", "away_shots_under_105": "away_shots",
    "away_shots_under_125": "away_shots", "away_shots_under_145": "away_shots",
    # Per-team fouls home (10.5-14.5)
    "home_fouls_over_105": "home_fouls", "home_fouls_over_125": "home_fouls",
    "home_fouls_over_145": "home_fouls",
    "home_fouls_under_105": "home_fouls", "home_fouls_under_125": "home_fouls",
    "home_fouls_under_145": "home_fouls",
    # Per-team fouls away (10.5-14.5)
    "away_fouls_over_105": "away_fouls", "away_fouls_over_125": "away_fouls",
    "away_fouls_over_145": "away_fouls",
    "away_fouls_under_105": "away_fouls", "away_fouls_under_125": "away_fouls",
    "away_fouls_under_145": "away_fouls",
    # Per-team yellows home (1.5-3.5)
    "home_yellows_over_15": "home_yellows", "home_yellows_over_25": "home_yellows",
    "home_yellows_over_35": "home_yellows",
    "home_yellows_under_15": "home_yellows", "home_yellows_under_25": "home_yellows",
    "home_yellows_under_35": "home_yellows",
    # Per-team yellows away (1.5-3.5)
    "away_yellows_over_15": "away_yellows", "away_yellows_over_25": "away_yellows",
    "away_yellows_over_35": "away_yellows",
    "away_yellows_under_15": "away_yellows", "away_yellows_under_25": "away_yellows",
    "away_yellows_under_35": "away_yellows",
...
LOW_IMPORTANCE_EXCLUSIONS: Dict[str, List[str]] = {
    ...
    "hgoals": [
        ...
        "away_offsides_ema",
        "away_offsides_vs_league",
        "expected_away_offsides",
        "expected_home_offsides",
        "expected_total_offsides",
        "expected_total_offsides_vs_league",
        "home_offsides",
        "home_offsides_conceded_ema",
        "home_offsides_ema",
        "home_offsides_vs_league",
        "negbin_offsides_expected_std",
        "negbin_offsides_over_45_prob",
        "offsides_attack_diff",
        "offsides_league_ema_avg",
        "offsides_league_rolling_std",
        "offsides_over_avg_35",
        "offsides_over_avg_45",
        "offsides_over_avg_55",
        "offsides_ratio_to_league",
        "offsides_under_avg_35",
...
class SniperOptimizer:
    ...
    def run_threshold_optimization(
        ...
        for fold, (train_start, train_end, test_start, test_end) in enumerate(cv_splits):
            ...
            # S31: Density ratio weights — DISABLED after full retrain showed TS regression
            # (83% rejection vs 75% baseline). Kept diagnostic logging only.
            # TODO: Re-enable after A/B testing with --density-ratio-weights flag
            ...
            if density_ratios is not None:
                logger.debug(f"  Density ratio (diagnostic only): dr_std={density_ratios.std():.3f}")
            ...
            for model_type in _base_types:
                ...
                if not is_holdout:
                    ...
                    if temp_cal is not None:
                        val_probs = temp_cal.transform(val_probs)
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    # Expand market group names to individual bet types via MARKET_MAPPING
    # e.g. "home_corners" → ["home_corners_over_35", "home_corners_under_35", ...]
    _group_to_variants = {}
    for variant, group in BASE_MARKET_MAP.items():
        _group_to_variants.setdefault(group, []).append(variant)
    expanded_bet_types = []
    for bt in bet_types:
        if bt in BET_TYPES:
            expanded_bet_types.append(bt)
        elif bt in _group_to_variants:
            variants = sorted(_group_to_variants[bt])
            logger.info(f"Expanding market group '{bt}' → {len(variants)} variants")
            expanded_bet_types.extend(variants)
        else:
            logger.warning(f"Unknown bet type: {bt}, skipping")
    bet_types = expanded_bet_types
