...
LINE_PLAUSIBILITY = {
    ...
    "ht": {"stat": "ht_total_goals", "buffer": 2.0},
    "sot": {"stat": "total_shots_on_target", "buffer": 3.0},
    "offsides": {"stat": "total_offsides", "buffer": 2.0},
    "bookpts": {"stat": "booking_points", "buffer": 15.0},
}
