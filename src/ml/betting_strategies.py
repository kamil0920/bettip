...
STRATEGY_REGISTRY: Dict[str, type] = {
    ...
    'shots': ShotsStrategy,
    'fouls': FoulsStrategy,
    # Cards line variants (1.5-6.5)
    'cards_over_15': CardsStrategy, 'cards_over_25': CardsStrategy,
    'cards_over_35': CardsStrategy, 'cards_over_45': CardsStrategy,
    'cards_over_55': CardsStrategy, 'cards_over_65': CardsStrategy,
    'cards_under_15': CardsStrategy, 'cards_under_25': CardsStrategy,
    'cards_under_35': CardsStrategy, 'cards_under_45': CardsStrategy,
    'cards_under_55': CardsStrategy, 'cards_under_65': CardsStrategy,
    # Corners line variants (8.5-11.5)
    'corners_over_85': CornersStrategy, 'corners_over_95': CornersStrategy,
    ...
    # Shots line variants (22.5-27.5)
    'shots_over_225': ShotsStrategy, 'shots_over_235': ShotsStrategy,
...
NICHE_LINE_LOOKUP: Dict[str, float] = {
    # Cards (1.5-6.5)
    'cards_over_15': 1.5, 'cards_over_25': 2.5, 'cards_over_35': 3.5,
    'cards_over_45': 4.5, 'cards_over_55': 5.5, 'cards_over_65': 6.5,
    'cards_under_15': 1.5, 'cards_under_25': 2.5, 'cards_under_35': 3.5,
    'cards_under_45': 4.5, 'cards_under_55': 5.5, 'cards_under_65': 6.5,
    # Corners (8.5-11.5)
    'corners_over_85': 8.5, 'corners_over_95': 9.5,
    ...
    # Shots (22.5-27.5)
    'shots_over_225': 22.5, 'shots_over_235': 23.5, 'shots_over_245': 24.5,
...
BASE_MARKET_MAP: Dict[str, str] = {
    ...
    # Shots (22.5-27.5)
    'shots_over_225': 'shots', 'shots_over_235': 'shots', 'shots_over_245': 'shots',
